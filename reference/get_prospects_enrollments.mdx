...
**Description**The Get Prospect Events Enrollments endpoint retrieves all your active prospect monitoring configurations. This allows you to review which individuals and event types you're currently tracking, along with enrollment details such as time-to-live settings..
