...
<Steps>
	<Step>
	Obtain Your API KeyYou’ll need a valid API key for all endpoints. For instructions on how to register and obtain credentials, see our **Authentication Guide**. [**Authentication Guide**](/reference/setup/getting_your_api_key)
	</Step>
	<Step>
...
[**Prospecting & Lead Enrichment**](/reference/quick-starts/use_case_prospecting) and reach out to ideal prospects with verified contact details.
