...
- **event\_name**: event type to simulate  - available types for simulation: new\_office, closing\_office, funding\_round, new\_investment, outages\_and\_security\_breaches (please note: enrollment is allowed on all of our event types)
