...
## Endpoint: `POST /v1/businesses/linkedin_posts/enrich`
...
| account\_handle | Account handle | Company's handle or username. | string |
| follower\_count | Follower count | Number of followers. | integer |
| post\_frequency | Post frequency | Frequency of posts. | string |
| engagement\_rate | Engagement rate | Average engagement rate. | number |
| content\_strategy | Content strategy | Type of content strategy. | string |
| brand\_sentiment | Brand sentiment | Overall brand sentiment. | string |
