...
### <Icon icon="robot" size={24} /> [OpenAI Integration](/reference/implement-with-openai)
...
<Columns cols={2}>
<Card icon="rocket-launch" horizontal title="Get Started with OpenAI" href="/reference/implement-with-openai" />
</Columns>

### <Icon icon="snake" size={24} /> [Python SDK](/reference/python-sdk-implementation-guide)
...
<Columns cols={2}>
<Card icon="rocket-launch" horizontal title="Get Started with Python SDK" href="/reference/python-sdk-implementation-guide" />
</Columns>
...
1. **AgentSource API Key** - [Get your API key](/reference/getting_your_api_key)
...
<Columns cols={2}>
<Card icon="book" horizontal title="AgentSource MCP API Reference" href="/reference/introduction" />
</Columns>
