...
## Endpoint: `POST /v1/businesses/events`
...
- [IPO Announcement](/reference/ipo-announcement) - Initial Public Offering announcement
- [New Funding Round](/reference/new-funding-round) - Announcement of a new funding round
- [New Investment](/reference/new-investment) - Announcement of a new investment

## Product & Business Growth

- [New Product Launch](/reference/new-product-launch) - Launch of a new product
- [New Office Opening](/reference/new-office-opening) - Opening of a new office
- [Office Closing](/reference/office-closing) - Closing of a company's office
- [Company's Award](/reference/companys-award-event) - Recognition of a company's achievements and accolades

## Partnerships & Mergers

- [New Partnership](/reference/new-partnership) - Announcement of a new partnership
- [Merger and Acquisitions](/reference/merger-and-acquisitions) - Tracks major M&A activity

## Hiring & Workforce Trends

- [Hiring (per department)](/reference/hiring-by-department) - Hiring by Department
- [Department trend (per department)](/reference/department-trend) - Workforce Changes by Department
- [Employee Joined Company](/reference/employee-joined-company) - Announcement of a new employee joining the company

## Legal & Security Issues

- [Lawsuits and Legal Issues](/reference/lawsuits-and-legal-issues) - Tracks legal challenges and regulatory issues
- [Outages and Security Breaches](/reference/outages-and-security-breaches) - Identifies major disruptions and cybersecurity incidents

## Financial Adjustments

- [Cost Cutting](/reference/cost-cutting) - Tracks significant cost reduction measures
