...
<Columns cols={2}>
    ...
    <Card icon="hand-holding-dollar" horizontal title="Cost Cutting" href="/reference/cost-cutting">
    Tracks significant cost reduction measures
    </Card>
    <Card icon="handshake" horizontal title="Merger and Acquisitions" href="/reference/merger-and-acquisitions">
