...
## Endpoint: `POST /v1/businesses/website_changes/enrich`
...
| :--- | :--- | :--- | :--- |
| change\_type | Change type | Type of content change (addition, deletion, modification). | string |
| page\_url | Page URL | URL of the page with changes. | url |
| change\_description | Change description | Description of the changes made. | string |
| change\_date | Change date | Date when the change was detected. | date |
