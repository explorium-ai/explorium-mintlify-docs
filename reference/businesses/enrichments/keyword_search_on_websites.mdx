...
## Endpoint: `POST /v1/businesses/company_website_keywords/enrich`
...
| search\_frequency | Search frequency | Frequency of the keyword on the website. | integer |
| page\_url | Page URL | URL where the keyword was found. | url |
