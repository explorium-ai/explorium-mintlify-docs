...
<AccordionGroup>
  ...
  <Accordion title="Best Practices">
    ...
    - **Mind your rate limit:** each prospect in the array counts as one query, so a 50-prospect match request uses 50 of your 200 queries per minute. See [Rate Limit](/reference/rate-limit) for details.
  </Accordion>
</AccordionGroup>
