...
<Columns cols={2}>
<Card icon="user-plus" horizontal title="Employee job changes" href="/reference/employee-job-changes">
Tracks when an employee changes their job title within the same company.
</Card>
<Card icon="calendar" horizontal title="Recently changed company" href="/reference/recently-changed-company">
