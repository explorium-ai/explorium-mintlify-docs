...
This n8n and agent-based workflow automates outbound prospecting by monitoring Explorium event data (e.g. product launches, new office opening, new investment and [more](/reference/ipo-announcement)), researching companies, identifying key contacts, and generating tailored sales emails leveraging the Explorium MCP server.
...
- Filters prospects by:
	...
	- Pay Attention: Follow our fetch prospect [documentation](/reference/fetch_prospects) for the full list of filter and best practice.
