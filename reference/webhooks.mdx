...
- **event\_type**: event type to simulate (currently available types: new\_office, closing\_office, funding\_round, new\_investment, outages\_and\_security\_breaches)
...
**Method**: GET  
**URL**: [https://api.explorium.ai/v1/webhooks/{partner_id}](https://api.explorium.ai/v1/webhooks/%7Bpartner_id%7D)
