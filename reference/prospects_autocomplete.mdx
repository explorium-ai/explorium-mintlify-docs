...
### Endpoint: `GET /prospects/autocomplete`
...
<Icon icon="thumbtack" color="red" iconType="solid"/> **Explore the sections above for additional query examples and integration guidelines.**
