...
<Columns cols={2}>
<Card icon="users" horizontal title="Hiring (per department)" href="/reference/hiring-by-department">
Hiring by Department
</Card>
<Card icon="user-plus" horizontal title="Employee Joined Company" href="/reference/employee-joined-company">
