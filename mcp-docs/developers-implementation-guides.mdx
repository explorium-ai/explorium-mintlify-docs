...
<Columns cols={2}>
<Card icon="rocket-launch" horizontal title="Get Started with OpenAI" href="/mcp-docs/implement-with-openai" />
</Columns>
...
<Columns cols={2}>
<Card icon="rocket-launch" horizontal title="Get Started with Python SDK" href="/mcp-docs/python-sdk-implementation-guide" />
</Columns>
...
<Columns cols={2}>
<Card icon="book" horizontal title="AgentSource MCP API Reference" href="/reference/quick-starts/introduction" />
</Columns>
...
*Ready to get started? Choose an implementation guide above or[contact our team](/reference/) for personalized recommendations.*
