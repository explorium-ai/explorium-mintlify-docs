---
title: "Google Sheets Company Enrichment with Explorium MCP"
description: "Automatically enrich company data in Google Sheets using Explorium's comprehensive B2B intelligence platform through n8n automation."
---
...
<Columns cols={2}>
<Card size={22} icon="rocket-launch" horizontal title="google_sheets_enrichment.json" href="https://drive.usercontent.google.com/u/0/uc?id=1SxlqU2hVn41e0XTjPx12Ryrx_yil3TUq&export=download" />
</Columns>

<Frame>
![](/images/reference/47bf118229ab009f2b78df40f3c1cac4d0a965d5a01b12ec1b3cd4d34f1c466e-image.png)
</Frame>
...
<Steps>
<Step>
Create a new google sheet (or make a copy of this [template](https://docs.google.com/spreadsheets/d/14PypuKFWkMftiCtPrekpbav63tEGmgGgUP3cDwv7wXE/edit?usp=sharing))
</Step>
...
<Steps>
    ...
    <Step>
        ...
        <Frame>
        ![](/images/reference/200aac6aa2ac8e4d671f50d8d6c2186e4c571449ec57610d5209a036c968caf1-image.png)
        </Frame>
    </Step>
    <Step>
    ...
    <Step>
    If working on n8n Instance, Follow the OAuth2 authentication process [here](https://docs.n8n.io/integrations/builtin/credentials/google/oauth-generic/#finish-your-n8n-credential)
    </Step>
    <Step>
    Fill the Client ID and Client Secret fields
    <Frame>
    ![](/images/reference/789e2e7e6f7921533ac90c703b4307f90d6b913b187632b61f2f0957687739c7-image.png)
    </Frame>
    </Step>
    <Step>
...
<Step>
Under Credentials, select the same credentials or create new ones (The same you did above)
</Step>
<Step>
...
<Frame>
![](/images/reference/d5647de529ef23690408c6633136648999496c573dfac31e135868f2d1e3e30e-image.png)
</Frame>
</Step>
<Step>
Save the credentials
...
<Steps>
    ...
    <Step>
    Under Credentials, click **Create New** (Header Auth)
    </Step>
    <Step>
    Fill the Name field with `api_key`
    </Step>
    <Step>
    Fill the Value field with your Explorium API Key
...
In the **Google Sheets Trigger** node:
	...
	<Frame>
![](/images/reference/a8b6a167d9bc140714c7bdd08af5c08597f0a58af73231d239a46c95410cf051-image.png)
</Frame>
</Step>
...
<Frame>
![](/images/reference/10bfafaaa3572bc805d5482d038348d41bced7b03bf94c8f04a377218d7dcaa3-image.png)
</Frame>
</Step>
</Steps>
