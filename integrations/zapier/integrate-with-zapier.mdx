...
<Steps>
    ...
    After setting up the webhook, enroll into the events you would wish to accept, this can be done with this api: [/reference/businesses/events/add\_businesses\_enrollments](/reference/add_businesses_enrollments) Here is an example call for that endpoint:
