...
- [ ] *(before GA)* stop reading `emails` from contact responses — use `professional_email`
- [ ] *(before GA)* `employee_joined_company` → `executive_joined_company` in event filters, enrollments, and payload handling
