...
## Endpoint: `GET /v2/businesses/autocomplete`
...
<AccordionGroup>
  ...
  <Accordion title="Example Request (cURL)">
    ...
    ```shell Bash
    curl -X GET \
      "https://api.explorium.ai/v2/businesses/autocomplete?field=country&query=unit" \
      -H "API_KEY: your_api_key_here"
    ```
   Example with business_intent_topics field. 
    ```shell Bash
    curl -X GET \
      'https://api.explorium.ai/v2/businesses/autocomplete?query=cloude&semantic_search=true&field=business_intent_topics' \
      -H "API_KEY: your_api_key_here"
    ```
