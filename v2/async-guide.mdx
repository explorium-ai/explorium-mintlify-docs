...
<CardGroup cols={2}>
  <Card title="sample-business-ids.csv" icon="file-csv" href="https://raw.githubusercontent.com/explorium-ai/explorium-mintlify-docs/main/images/sample-business-ids.csv">
    Six business IDs — download and use as-is
  </Card>
  <Card title="sample-prospect-ids.csv" icon="file-csv" href="https://raw.githubusercontent.com/explorium-ai/explorium-mintlify-docs/main/images/sample-prospect-ids.csv">
    Three prospect IDs
  </Card>
</CardGroup>
