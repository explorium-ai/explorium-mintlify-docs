...
<Info>
  **Draft.** These pages are being written ahead of the v2 GA and describe planned behavior. Paths, fields, and timing may still change.
</Info>
...
<Columns cols={2}>
  ...
  <Card title="Credits" icon="coins" href="/v2/endpoints/credits">
