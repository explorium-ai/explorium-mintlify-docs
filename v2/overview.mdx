...
<Info>
  **Already integrated with v1?** Your integration keeps working — v1 runs in parallel and remains fully documented. Switch to **v1** in the version picker (top left) or go straight to the [v1 documentation](/reference/quick-starts/quick-starts). When you're ready to move, the [migration guide](/v2/migration-from-v1) maps every v1 endpoint to its v2 replacement and lists the breaking changes.
</Info>
...
<Columns cols={3}>
  ...
  <Card title="Upgrade skill" icon="wand-magic-sparkles" href="/v2/upgrade-skill">
    Let a coding agent apply the migration for you
  </Card>
</Columns>
