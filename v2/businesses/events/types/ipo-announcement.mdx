...
<Columns columns={2}>
    <Card icon="dollar-sign" horizontal title="New Funding Round" href="/v2/businesses/events/types/new-funding-round">
    Announcement of a new funding round
    </Card>
    <Card icon="chart-line" horizontal title="New Investment" href="/v2/businesses/events/types/new-investment">
