...
**Event Name: "executive_joined_company" (Use this value in the event_types parameter when querying this event.)**
...
<Columns cols={2}>
  <Card title="Hiring (per department)" icon="users" horizontal href="/v2/businesses/events/types/hiring-by-department">
    Hiring by Department
  </Card>
  <Card title="Department trend (per department)" icon="user-plus" horizontal href="/v2/businesses/events/types/department-trend">
