...
<Columns cols={2}>
<Card icon="award" horizontal title="Merger and Acquisitions" href="/v2/businesses/events/types/merger-and-acquisitions">
Tracks major M&A activity.
</Card>
<Card icon="dollar-sign" horizontal title="Funding Round" href="/v2/businesses/events/types/companys-award-event">
Monitors new investment rounds for businesses.
</Card>
<Card icon="handshake" horizontal title="New Partnership" href="/v2/businesses/events/types/new-partnership">
