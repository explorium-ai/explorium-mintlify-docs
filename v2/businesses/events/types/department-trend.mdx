...
<Columns cols={2}>
<Card icon="users" horizontal title="Hiring (per department)" href="/v2/businesses/events/types/hiring-by-department">
Hiring by Department
</Card>
<Card icon="user-plus" horizontal title="New Executive Level Hires" href="/v2/businesses/events/types/executive-joined-company">
