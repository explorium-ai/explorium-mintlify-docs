...
<Columns cols={2}>
    <Card icon="shield-halved" horizontal title="Outages and Security Breaches" href="/v2/businesses/events/types/outages-and-security-breaches">
    Identifies major disruptions and cybersecurity incidents
    </Card>
    <Card icon="hand-holding-dollar" horizontal title="Cost Cutting" href="/v2/businesses/events/types/cost-cutting">
    Tracks significant cost reduction measures
    </Card>
    <Card icon="handshake" horizontal title="Merger and Acquisitions" href="/v2/businesses/events/types/merger-and-acquisitions">
