...
sidebarTitle: "Fetch business events"
openapi: "post /v2/businesses/events"
---
...
<Note>
  **v2:** requests accept up to **40 `business_ids`** per call. Delivered `new_funding_round` payloads use the corrected `funding_stage` / `funding_date` field names (v1 spells them `founding_*`) — see [signal fixes](/v2/whats-new#signal-fixes).
</Note>
...
<AccordionGroup>
  ...
  <Accordion title="Query Parameters">
    ...
    | `business_ids`   | Array  | Returns events related to specific businesses using their Business IDs                                               — up to **40 per request** |
  ...
  <Accordion title="Example Request (cURL)">
    ```shell Bash
    curl -X POST \
      "https://api.explorium.ai/v2/businesses/events" \
  ...
  <Accordion title="Event Categories">
    ...
    - [IPO Announcement](/v2/businesses/events/types/ipo-announcement) - Initial Public Offering announcement
    - [New Funding Round](/v2/businesses/events/types/new-funding-round) - Announcement of a new funding round
    - [New Investment](/v2/businesses/events/types/new-investment) - Announcement of a new investment

    ## Product & Business Growth

    - [New Product Launch](/v2/businesses/events/types/new-product-launch) - Launch of a new product
    - [New Office Opening](/v2/businesses/events/types/new-office-opening) - Opening of a new office
    - [Office Closing](/v2/businesses/events/types/office-closing) - Closing of a company's office
    - [Company's Award](/v2/businesses/events/types/companys-award-event) - Recognition of a company's achievements and accolades

    ## Partnerships & Mergers

    - [New Partnership](/v2/businesses/events/types/new-partnership) - Announcement of a new partnership
    - [Merger and Acquisitions](/v2/businesses/events/types/merger-and-acquisitions) - Tracks major M&A activity

    ## Hiring & Workforce Trends

    - [Hiring (per department)](/v2/businesses/events/types/hiring-by-department) - Hiring by Department
    - [Department trend (per department)](/v2/businesses/events/types/department-trend) - Workforce Changes by Department
    - [New executive level hires](/v2/businesses/events/types/executive-joined-company) - Announcement of a new executive joining the company

    ## Legal & Security Issues

    - [Lawsuits and Legal Issues](/v2/businesses/events/types/lawsuits-and-legal-issues) - Tracks legal challenges and regulatory issues
    - [Outages and Security Breaches](/v2/businesses/events/types/outages-and-security-breaches) - Identifies major disruptions and cybersecurity incidents

    ## Financial Adjustments

    - [Cost Cutting](/v2/businesses/events/types/cost-cutting) - Tracks significant cost reduction measures
  </Accordion>
</AccordionGroup>
