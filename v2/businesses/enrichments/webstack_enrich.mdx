...
<AccordionGroup>
  ...
  <Accordion title="Example Response">
    ...
    "data": {
      ...
      "live_techs": true,
      "money_spent_on_website_technologies": 11596,
  ...
  <Accordion title="Webstack Output Signals">
    ...
    | money_spent_on_website_technologies  | Estimated average monthly spending on webstack        | Estimated monthly financial investment in the technologies used on the company's website, displayed in USD. Calculation: sum of the average price point for each technology used on the website.                                                                                                                                                                                                                                                                                                        | NUMERIC   |
