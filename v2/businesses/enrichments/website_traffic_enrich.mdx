...
openapi: "post /v2/businesses/website_traffic/enrich"
---

<Warning>
  **Deprecated.** The Website traffic enrichment is deprecated and will be removed in a future release. Don't build new integrations on it; existing requests keep responding for now, but the data is no longer maintained.
</Warning>
...
<AccordionGroup>
  ...
  <Accordion title="Example Request (cURL)">
    ```bash
    curl -X 'POST' \
    'https://api.explorium.ai/v2/businesses/website_traffic/enrich' \
