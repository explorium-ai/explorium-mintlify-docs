...
The asynchronous variant of **Businesses Research**. It submits a custom, AI-powered research task over a dataset of businesses as a job, rather than returning results in the response.
