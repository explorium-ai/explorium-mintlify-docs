...
The asynchronous variant of **Prospects Research**. It submits a custom, AI-powered research task over a list of prospects as a job, rather than returning results in the response.

<Info>
  **Beta.** Request/response shape and the credit model may change before GA. During the beta, research runs in **sync mode only** — use [Prospects research](/v2/research/prospects_research_enrich) until the async variant is enabled.
</Info>
