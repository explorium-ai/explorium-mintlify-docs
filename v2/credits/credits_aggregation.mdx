...
<ResponseField name="response_context" type="object">
  ...
  <Expandable title="properties">
    ...
    <ResponseField name="time_taken_in_seconds" type="number">
...
curl --request POST \
  --url https://api.explorium.ai/v2/credits/aggregation \
