...
<AccordionGroup>
  ...
  | --------- | ------ | ------------------------------------------------------------------------------------------------------- | -------- |
  | `filters` | Object | Filter criteria to define the prospect universe. Supports all filters from the `/v2/prospects` endpoint | No       |
  ...
  **Note:** See the "Supported Filters" section below for the complete list of available filters and their usage.
  ...
  <Accordion title="Supported Filters" icon="sparkles">
      This endpoint supports **ALL filters** available in the `/v2/prospects` fetch endpoint:
  ...
  * Validate contact availability with `has_contact_details`
  ...
  * **All filters supported:** Every filter from the `/v2/prospects` endpoint works here
  </Accordion>
</AccordionGroup>
