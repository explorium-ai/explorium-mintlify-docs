---
title: "Fetch prospect events"
sidebarTitle: "Fetch prospect events"
openapi: "post /v2/prospects/events"
---
...
<Note>
  **v2:** requests accept up to **40 `prospect_ids`** per call.
</Note>
...
| :--- | :--- |
| [prospect\_changed\_role](/v2/prospects/events/types/employee_job_changes) | Prospect has changed their role. |
| [prospect\_changed\_company](/v2/prospects/events/types/recently_changed_company) | Prospect has changed their company. |
| [prospect\_job\_start\_anniversary](/v2/prospects/events/types/employee_workplace_anniversary) | Employee's workplace anniversary, marking the anniversary of the employee's start date at their company. |
</Accordion>
...
- [Employee job changes](/v2/prospects/events/types/employee_job_changes) - Tracks when an employee changes their job title within the same company.
