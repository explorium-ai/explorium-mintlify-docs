...
<Columns cols={2}>
  <Card title="Employee job changes" icon="user-plus" horizontal href="/v2/prospects/events/types/employee_job_changes">
    Tracks when an employee changes their job title within the same company.
  </Card>
  <Card title="Recently changed company" icon="calendar" horizontal href="/v2/prospects/events/types/recently_changed_company">
