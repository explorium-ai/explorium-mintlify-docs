...
Everything below shipped together at v2 GA (September 2026).
...
| [Webhooks](/v2/endpoints/webhooks) | Multi-webhook, tenant-scoped management: register, list, update, and delete by `webhook_id`, per-webhook secret rotation, and connectivity checks. |
